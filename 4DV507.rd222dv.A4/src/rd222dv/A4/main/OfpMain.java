...
import rd222dv.A4.bytecodeGenerator.ByteCodeGenerator;
...
import rd222dv.A4.antlr4.OfpLexer;
...
public class OfpMain {
	...
	public static void main(String[] args) throws Exception {
		...
		/*rd222dv.A4.main.OfpMain loader = new rd222dv.A4.main.OfpMain();
		Class<?> exampleClass = loader.defineClass("arithmetics", code, 0 , code.length);
