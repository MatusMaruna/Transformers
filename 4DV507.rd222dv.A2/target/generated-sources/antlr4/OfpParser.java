...
public class OfpParser extends Parser {
	...
	public static final int
		...
		RULE_stmt = 9, RULE_expr = 10, RULE_localDecl = 11, RULE_declaration = 12, 
		RULE_asgnStmt = 13, RULE_methodCall = 14, RULE_arrayList = 15, RULE_array = 16, 
		RULE_arrType = 17, RULE_whileStmt = 18, RULE_ifStmt = 19, RULE_condition = 20, 
		RULE_print = 21;
	public static final String[] ruleNames = {
		"start", "main", "method", "parameter", "parameterList", "block", "returnStmt", 
		"type", "varType", "stmt", "expr", "localDecl", "declaration", "asgnStmt", 
		"methodCall", "arrayList", "array", "arrType", "whileStmt", "ifStmt", 
		"condition", "print"
	};
	...
	public final StmtContext stmt() throws RecognitionException {
		...
		try {
			...
			case 6:
				...
				{
				setState(153); returnStmt();
				}
				break;
			case 7:
				enterOuterAlt(_localctx, 7);
				{
				setState(154); methodCall();
				}
				break;
			}
		}
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case 5:
				{
				setState(169); varType();
				}
				break;
			case 6:
				{
				setState(170); arrayList();
				}
				break;
			case 7:
				{
				setState(171); arrType();
				}
				break;
			}
